                    ...
                    <tbody className="text-gray-900">
                        <tr  className="bg-white border-b hover:bg-gray-100/50  ">
                            ...
                            <td className="px-2 py-4 text-right">
                                ...
                                >
                                <Link to={'/admin/jadwal/psikotes-mandiri-taspen'}><FaEye className="text-gray-600 cursor-pointer hover:text-lineColor"/></Link> 
                        ...
                        <tr className="bg-white border-b hover:bg-gray-100/50 cursor-pointer">
                            <th
                                scope="row"
                                className="pl-6 py-4 font-medium text-gray-900 whitespace-nowrap"
                            >
